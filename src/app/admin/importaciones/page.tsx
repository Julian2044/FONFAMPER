    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        {steps.map((step, index) => (
          <Card key={step} className={index === 0 ? "border-blue-200 bg-blue-50" : ""}>
      ...
      <div className="grid gap-6 xl:grid-cols-[1fr_360px]">
        ...
        <Card>
          ...
          <div className="mt-5 space-y-4 text-sm">
            <div className="flex items-center gap-2 text-emerald-700"><CheckCircle2 className="h-5 w-5" /><span className="font-bold">Totales coinciden</span></div>
            <div className="flex items-center gap-2 text-emerald-700"><CheckCircle2 className="h-5 w-5" /><span className="font-bold">8 registros válidos</span></div>
            <div className="rounded-2xl bg-slate-50 p-4">
              <FileSpreadsheet className="h-6 w-6 text-[#0057d9]" />
              <p className="mt-3 font-bold text-slate-950">Aportes_mensuales_mayo_2024.xlsx</p>
              <p className="mt-1 text-slate-500">12,4 KB · 8 filas</p>
            </div>
          </div>
        </Card>
      </div>
      ...
      <Card>
        ...
        <DataTable
          columns={["Nombre", "Acumulado año 2022 (Saldo base)", "Ene", "Feb", "Mar", "Total", "Estado"]}
